...
<tr bgcolor="#aadeff">
<td class="text" width="116"><div align="center">教师编号</div></td>
<td width="297" height="30"><input type="text" name="teacher_ID"></td>
<td class="text" width="116"><div align="center">教师姓名</div></td>
...
<td bgcolor="#FFFF"><div class="text" align="center">删除</div></td>

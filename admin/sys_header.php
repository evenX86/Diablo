...
<a href="teacher_query.php">教师信息</a><br>
<a href="subject_query.php">论文信息</a><br>
</div>
</div>

<div id="menu4" class="menu" onmouseover="show('menu4');" onmouseout="hide('menu4');">
<div class="menuHead">信息添加</div>
<div id="menu4choices" class="menuChoices">
<a href="teacher.php">教师信息</a><br>
<a href="student.php">学生信息</a><br>
</div>
</div>

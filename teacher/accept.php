...
<table width="860" align="center" cellspacing="1" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td>
            <div align="right" class="text">删除</div>
        </td>
    ...
    <tr bgcolor="#aadeff">
        ...
        ?>
        <td width="30%">
            <div class="title"><?php echo "" . $row['M_from'] . ""; ?></div>
        </td>
        <?php
        $M_title = $row['M_title'];
        ...
        <td width="35%">
            <div
                class="title"><?php echo "<a href=accept_content.php?M_from=" . $row['M_from'] . "&M_ID=" . $row_two['M_ID'] . "><font color=\"#000000\">" . $row['M_title'] . "</font></a>"; ?></div>
        </td>

        <td width="20%">
            <div class="title"><?php echo "" . $row['M_time'] . ""; ?></div>
        </td>
        <td width="15%">
            <div align="right"
                 class="title"><?php echo "<a href=accept_del.php?M_from=" . $row['M_from'] . "&M_time=" . $row['M_time'] . "><font color=\"#bc0000\" size=\"3\">删除</font></a>"; ?></div>
        </td>
    </tr>
    <?php
    $n++;

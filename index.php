...
<table width=860 align="center" bgcolor="#e3f3ff">
<tr>
...
<br>
<li>
<label><font color="#dbeefd">用户名:</font></label><input style="height:25px" size="10" name="user_ID" type="text" id="user_ID" />
</li> 
<br>
<li>
<label><font color="dbeefd">密&nbsp;&nbsp;&nbsp;码:</font></label><input style="height:26px" size="10" name="user_passwd" type="password" id="user_passwd" />
</li>
